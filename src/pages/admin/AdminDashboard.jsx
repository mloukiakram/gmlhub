                ...
                <div className="mb-6">
                    <div className="relative max-w-md">
                        ...
                        <input
                            ...
                            className="w-full pl-10 h-10 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg outline-none focus:border-blue-500 text-sm"
                        />
                    </div>
                </div>
