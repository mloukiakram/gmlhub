        ...
        <div className="h-full flex flex-col bg-base transition-colors duration-300">
            ...
            <div className="flex-1 overflow-hidden p-6 flex gap-6">
                ...
                <div className="flex-1 flex flex-col gap-6 overflow-hidden">
                    {/* Config Output */}
                    <div className="flex-1 flex flex-col bg-slate-200 dark:bg-slate-900 rounded-lg border border-slate-300 dark:border-slate-700 shadow-none overflow-hidden h-1/2">
